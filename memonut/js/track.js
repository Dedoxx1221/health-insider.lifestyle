...
var initialSrc = "https://go.trustedmediahub.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("go.trustedmediahub.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://go.trustedmediahub.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://go.trustedmediahub.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
        ...
        const interval = setInterval(() => {
            try {
                ...
                if ((fbp || fbc) && clickId) {
                    ...
                    const url = new URL('https://go.trustedmediahub.com/clickupd/' + clickId)
